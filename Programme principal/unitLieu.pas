...
type
  TTableau = array [1..7] of Boolean;       // 1 = Blancherive // 2 = Marché de Blancherive // 3 = Chateau //4 = Porte de la ville // 5 = Boutique // 6 = Inventaire
...
var lieu1, lieu2, lieu3, lieu4, lieu5, lieu6, lieu7, position : TInformation;
    ...
    for i:= 1 to 7 do
      if position.possibiliteLieu[i] then
        case i of
          ...
          7:begin writelnPerso(lieu7.nom); listePos := listePos + IntToStr(i);end;
        end;
